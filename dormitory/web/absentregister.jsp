...
<head>
    ...
    <script src="js/momentjs-cn_downloads_moment-with-locales-min-js.js"></script>
    <script src="js/bootstrap-datetimepicker-min-js.js"></script>
    <title>宿舍管理系统</title>
</head>
<body>
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                <%--@declare id="user_id"--%><label for="user_id" class="col-sm-3 control-label">楼宇</label>
                                <div class="col-sm-9">
